...
namespace Quantum.Prototypes {
  ...
  [System.SerializableAttribute()]
  [Quantum.Prototypes.Prototype(typeof(Quantum.AttackRange))]
  public unsafe partial class AttackRangePrototype : ComponentPrototype<Quantum.AttackRange> {
    public FP MinRange;
    public FP MaxRange;
    public FP CurrentRange;
    public FP ExpansionRate;
    public FP ContractionRate;
    partial void MaterializeUser(Frame frame, ref Quantum.AttackRange result, in PrototypeMaterializationContext context);
    public override Boolean AddToEntity(FrameBase f, EntityRef entity, in PrototypeMaterializationContext context) {
        Quantum.AttackRange component = default;
        Materialize((Frame)f, ref component, in context);
        return f.Set(entity, component) == SetResult.ComponentAdded;
    }
    public void Materialize(Frame frame, ref Quantum.AttackRange result, in PrototypeMaterializationContext context = default) {
        result.MinRange = this.MinRange;
        result.MaxRange = this.MaxRange;
        result.CurrentRange = this.CurrentRange;
        result.ExpansionRate = this.ExpansionRate;
        result.ContractionRate = this.ContractionRate;
        MaterializeUser(frame, ref result, in context);
    }
  }
  [System.SerializableAttribute()]
  ...
  [System.SerializableAttribute()]
  [Quantum.Prototypes.Prototype(typeof(Quantum.BasicUltimate))]
  public unsafe partial class BasicUltimatePrototype : ComponentPrototype<Quantum.BasicUltimate> {
    [HideInInspector()]
    public Int32 _empty_prototype_dummy_field_;
    partial void MaterializeUser(Frame frame, ref Quantum.BasicUltimate result, in PrototypeMaterializationContext context);
    public override Boolean AddToEntity(FrameBase f, EntityRef entity, in PrototypeMaterializationContext context) {
        Quantum.BasicUltimate component = default;
        Materialize((Frame)f, ref component, in context);
        return f.Set(entity, component) == SetResult.ComponentAdded;
    }
    public void Materialize(Frame frame, ref Quantum.BasicUltimate result, in PrototypeMaterializationContext context = default) {
        MaterializeUser(frame, ref result, in context);
    }
  }
  [System.SerializableAttribute()]
  ...
  [System.SerializableAttribute()]
  [Quantum.Prototypes.Prototype(typeof(Quantum.BushCollider))]
  public unsafe partial class BushColliderPrototype : ComponentPrototype<Quantum.BushCollider> {
    [HideInInspector()]
    public Int32 _empty_prototype_dummy_field_;
    partial void MaterializeUser(Frame frame, ref Quantum.BushCollider result, in PrototypeMaterializationContext context);
    public override Boolean AddToEntity(FrameBase f, EntityRef entity, in PrototypeMaterializationContext context) {
        Quantum.BushCollider component = default;
        Materialize((Frame)f, ref component, in context);
        return f.Set(entity, component) == SetResult.ComponentAdded;
    }
    public void Materialize(Frame frame, ref Quantum.BushCollider result, in PrototypeMaterializationContext context = default) {
        MaterializeUser(frame, ref result, in context);
    }
  }
  [System.SerializableAttribute()]
  [Quantum.Prototypes.Prototype(typeof(Quantum.BushTemporaryReveal))]
  public unsafe partial class BushTemporaryRevealPrototype : ComponentPrototype<Quantum.BushTemporaryReveal> {
    public FP Value;
    partial void MaterializeUser(Frame frame, ref Quantum.BushTemporaryReveal result, in PrototypeMaterializationContext context);
    public override Boolean AddToEntity(FrameBase f, EntityRef entity, in PrototypeMaterializationContext context) {
        Quantum.BushTemporaryReveal component = default;
        Materialize((Frame)f, ref component, in context);
        return f.Set(entity, component) == SetResult.ComponentAdded;
    }
    public void Materialize(Frame frame, ref Quantum.BushTemporaryReveal result, in PrototypeMaterializationContext context = default) {
        result.Value = this.Value;
        MaterializeUser(frame, ref result, in context);
    }
  }
  ...
  [System.SerializableAttribute()]
  [Quantum.Prototypes.Prototype(typeof(Quantum.Dummy))]
  public unsafe partial class DummyPrototype : ComponentPrototype<Quantum.Dummy> {
    [HideInInspector()]
    public Int32 _empty_prototype_dummy_field_;
    partial void MaterializeUser(Frame frame, ref Quantum.Dummy result, in PrototypeMaterializationContext context);
    public override Boolean AddToEntity(FrameBase f, EntityRef entity, in PrototypeMaterializationContext context) {
        Quantum.Dummy component = default;
        Materialize((Frame)f, ref component, in context);
        return f.Set(entity, component) == SetResult.ComponentAdded;
    }
    public void Materialize(Frame frame, ref Quantum.Dummy result, in PrototypeMaterializationContext context = default) {
        MaterializeUser(frame, ref result, in context);
    }
  }
  [System.SerializableAttribute()]
  ...
  [System.SerializableAttribute()]
  [Quantum.Prototypes.Prototype(typeof(Quantum.HiddenPreventsAttack))]
  public unsafe partial class HiddenPreventsAttackPrototype : ComponentPrototype<Quantum.HiddenPreventsAttack> {
    [HideInInspector()]
    public Int32 _empty_prototype_dummy_field_;
    partial void MaterializeUser(Frame frame, ref Quantum.HiddenPreventsAttack result, in PrototypeMaterializationContext context);
    public override Boolean AddToEntity(FrameBase f, EntityRef entity, in PrototypeMaterializationContext context) {
        Quantum.HiddenPreventsAttack component = default;
        Materialize((Frame)f, ref component, in context);
        return f.Set(entity, component) == SetResult.ComponentAdded;
    }
    public void Materialize(Frame frame, ref Quantum.HiddenPreventsAttack result, in PrototypeMaterializationContext context = default) {
        MaterializeUser(frame, ref result, in context);
    }
  }
  [System.SerializableAttribute()]
  [Quantum.Prototypes.Prototype(typeof(Quantum.HitBuffer))]
  public unsafe class HitBufferPrototype : ComponentPrototype<Quantum.HitBuffer> {
    [DynamicCollectionAttribute()]
    public MapEntityId[] Value = {};
    public override Boolean AddToEntity(FrameBase f, EntityRef entity, in PrototypeMaterializationContext context) {
        Quantum.HitBuffer component = default;
        Materialize((Frame)f, ref component, in context);
        return f.Set(entity, component) == SetResult.ComponentAdded;
    }
    public void Materialize(Frame frame, ref Quantum.HitBuffer result, in PrototypeMaterializationContext context = default) {
        if (this.Value.Length == 0) {
          result.Value = default;
        } else {
          var list = frame.AllocateList(out result.Value, this.Value.Length);
  ...
  [System.SerializableAttribute()]
  [Quantum.Prototypes.Prototype(typeof(Quantum.InBush))]
  public unsafe partial class InBushPrototype : ComponentPrototype<Quantum.InBush> {
    [HideInInspector()]
    public Int32 _empty_prototype_dummy_field_;
    partial void MaterializeUser(Frame frame, ref Quantum.InBush result, in PrototypeMaterializationContext context);
    public override Boolean AddToEntity(FrameBase f, EntityRef entity, in PrototypeMaterializationContext context) {
        Quantum.InBush component = default;
        Materialize((Frame)f, ref component, in context);
        return f.Set(entity, component) == SetResult.ComponentAdded;
    }
    public void Materialize(Frame frame, ref Quantum.InBush result, in PrototypeMaterializationContext context = default) {
        MaterializeUser(frame, ref result, in context);
    }
  }
  [System.SerializableAttribute()]
  ...
  public unsafe partial class InputPrototype : StructPrototype {
    ...
    public void Materialize(Frame frame, ref Quantum.Input result, in PrototypeMaterializationContext context = default) {
        ...
        result.UltDirection = this.UltDirection;
        result.FinalUltDirection = this.FinalUltDirection;
        result.IsUltimate = this.IsUltimate;
        MaterializeUser(frame, ref result, in context);
    }
  }
  [System.SerializableAttribute()]
  ...
  [System.SerializableAttribute()]
  [Quantum.Prototypes.Prototype(typeof(Quantum.IsVisibleToEnemies))]
  public unsafe partial class IsVisibleToEnemiesPrototype : ComponentPrototype<Quantum.IsVisibleToEnemies> {
    [HideInInspector()]
    public Int32 _empty_prototype_dummy_field_;
    partial void MaterializeUser(Frame frame, ref Quantum.IsVisibleToEnemies result, in PrototypeMaterializationContext context);
    public override Boolean AddToEntity(FrameBase f, EntityRef entity, in PrototypeMaterializationContext context) {
        Quantum.IsVisibleToEnemies component = default;
        Materialize((Frame)f, ref component, in context);
        return f.Set(entity, component) == SetResult.ComponentAdded;
    }
    public void Materialize(Frame frame, ref Quantum.IsVisibleToEnemies result, in PrototypeMaterializationContext context = default) {
        MaterializeUser(frame, ref result, in context);
    }
  }
  [System.SerializableAttribute()]
  [Quantum.Prototypes.Prototype(typeof(Quantum.Kill))]
  public unsafe partial class KillPrototype : ComponentPrototype<Quantum.Kill> {
    [HideInInspector()]
    public Int32 _empty_prototype_dummy_field_;
    partial void MaterializeUser(Frame frame, ref Quantum.Kill result, in PrototypeMaterializationContext context);
    public override Boolean AddToEntity(FrameBase f, EntityRef entity, in PrototypeMaterializationContext context) {
        Quantum.Kill component = default;
        Materialize((Frame)f, ref component, in context);
        return f.Set(entity, component) == SetResult.ComponentAdded;
    }
    public void Materialize(Frame frame, ref Quantum.Kill result, in PrototypeMaterializationContext context = default) {
        MaterializeUser(frame, ref result, in context);
    }
  }
  [System.SerializableAttribute()]
  ...
  [System.SerializableAttribute()]
  [Quantum.Prototypes.Prototype(typeof(Quantum.ObstacleEntity))]
  public unsafe partial class ObstacleEntityPrototype : ComponentPrototype<Quantum.ObstacleEntity> {
    [HideInInspector()]
    public Int32 _empty_prototype_dummy_field_;
    partial void MaterializeUser(Frame frame, ref Quantum.ObstacleEntity result, in PrototypeMaterializationContext context);
    public override Boolean AddToEntity(FrameBase f, EntityRef entity, in PrototypeMaterializationContext context) {
        Quantum.ObstacleEntity component = default;
        Materialize((Frame)f, ref component, in context);
        return f.Set(entity, component) == SetResult.ComponentAdded;
    }
    public void Materialize(Frame frame, ref Quantum.ObstacleEntity result, in PrototypeMaterializationContext context = default) {
        MaterializeUser(frame, ref result, in context);
    }
  }
  [System.SerializableAttribute()]
  [Quantum.Prototypes.Prototype(typeof(Quantum.ObstaclePreventsAttack))]
  public unsafe class ObstaclePreventsAttackPrototype : ComponentPrototype<Quantum.ObstaclePreventsAttack> {
    public Quantum.Prototypes.PlayerLinkPrototype Value;
    public override Boolean AddToEntity(FrameBase f, EntityRef entity, in PrototypeMaterializationContext context) {
        Quantum.ObstaclePreventsAttack component = default;
        Materialize((Frame)f, ref component, in context);
        return f.Set(entity, component) == SetResult.ComponentAdded;
    }
    public void Materialize(Frame frame, ref Quantum.ObstaclePreventsAttack result, in PrototypeMaterializationContext context = default) {
        this.Value.Materialize(frame, ref result.Value, in context);
    }
  }
  [System.SerializableAttribute()]
  ...
  [System.SerializableAttribute()]
  [Quantum.Prototypes.Prototype(typeof(Quantum.Poison))]
  public unsafe partial class PoisonPrototype : ComponentPrototype<Quantum.Poison> {
    [HideInInspector()]
    public Int32 _empty_prototype_dummy_field_;
    partial void MaterializeUser(Frame frame, ref Quantum.Poison result, in PrototypeMaterializationContext context);
    public override Boolean AddToEntity(FrameBase f, EntityRef entity, in PrototypeMaterializationContext context) {
        Quantum.Poison component = default;
        Materialize((Frame)f, ref component, in context);
        return f.Set(entity, component) == SetResult.ComponentAdded;
    }
    public void Materialize(Frame frame, ref Quantum.Poison result, in PrototypeMaterializationContext context = default) {
        MaterializeUser(frame, ref result, in context);
    }
  }
  [System.SerializableAttribute()]
  ...
  [System.SerializableAttribute()]
  [Quantum.Prototypes.Prototype(typeof(Quantum.StatusEffectTypeId))]
  public unsafe partial class StatusEffectTypeIdPrototype : ComponentPrototype<Quantum.StatusEffectTypeId> {
    public Quantum.QEnum32<EStatusEffectTypeId> Value;
    partial void MaterializeUser(Frame frame, ref Quantum.StatusEffectTypeId result, in PrototypeMaterializationContext context);
    public override Boolean AddToEntity(FrameBase f, EntityRef entity, in PrototypeMaterializationContext context) {
        Quantum.StatusEffectTypeId component = default;
        Materialize((Frame)f, ref component, in context);
        return f.Set(entity, component) == SetResult.ComponentAdded;
    }
    public void Materialize(Frame frame, ref Quantum.StatusEffectTypeId result, in PrototypeMaterializationContext context = default) {
        result.Value = this.Value;
        MaterializeUser(frame, ref result, in context);
    }
  }
  ...
  public unsafe partial class StatusSetupPrototype : StructPrototype {
    ...
    public Quantum.QEnum32<EStatusEffectTypeId> StatusEffectTypeId;
    public FP Value;
    public FP Duration;
    public FP Period;
    ...
    public void Materialize(Frame frame, ref Quantum.StatusSetup result, in PrototypeMaterializationContext context = default) {
        ...
        result.StatusEffectTypeId = this.StatusEffectTypeId;
        result.Value = this.Value;
  ...
  [System.SerializableAttribute()]
  [Quantum.Prototypes.Prototype(typeof(Quantum.TargetsHitCooldown))]
  public unsafe class TargetsHitCooldownPrototype : ComponentPrototype<Quantum.TargetsHitCooldown> {
    [DynamicCollectionAttribute()]
    public MapEntityId[] Value = {};
    public override Boolean AddToEntity(FrameBase f, EntityRef entity, in PrototypeMaterializationContext context) {
        Quantum.TargetsHitCooldown component = default;
        Materialize((Frame)f, ref component, in context);
        return f.Set(entity, component) == SetResult.ComponentAdded;
    }
    public void Materialize(Frame frame, ref Quantum.TargetsHitCooldown result, in PrototypeMaterializationContext context = default) {
        if (this.Value.Length == 0) {
          result.Value = default;
        } else {
          var list = frame.AllocateList(out result.Value, this.Value.Length);
  ...
  [System.SerializableAttribute()]
  [Quantum.Prototypes.Prototype(typeof(Quantum.TemporaryTargetable))]
  public unsafe partial class TemporaryTargetablePrototype : ComponentPrototype<Quantum.TemporaryTargetable> {
    [HideInInspector()]
    public Int32 _empty_prototype_dummy_field_;
    partial void MaterializeUser(Frame frame, ref Quantum.TemporaryTargetable result, in PrototypeMaterializationContext context);
    public override Boolean AddToEntity(FrameBase f, EntityRef entity, in PrototypeMaterializationContext context) {
        Quantum.TemporaryTargetable component = default;
        Materialize((Frame)f, ref component, in context);
        return f.Set(entity, component) == SetResult.ComponentAdded;
    }
    public void Materialize(Frame frame, ref Quantum.TemporaryTargetable result, in PrototypeMaterializationContext context = default) {
        MaterializeUser(frame, ref result, in context);
    }
  }
  [System.SerializableAttribute()]
  ...
  [System.SerializableAttribute()]
  [Quantum.Prototypes.Prototype(typeof(Quantum.UltDirection))]
  public unsafe partial class UltDirectionPrototype : ComponentPrototype<Quantum.UltDirection> {
    public FPVector3 Value;
    partial void MaterializeUser(Frame frame, ref Quantum.UltDirection result, in PrototypeMaterializationContext context);
    public override Boolean AddToEntity(FrameBase f, EntityRef entity, in PrototypeMaterializationContext context) {
        Quantum.UltDirection component = default;
        Materialize((Frame)f, ref component, in context);
        return f.Set(entity, component) == SetResult.ComponentAdded;
    }
    public void Materialize(Frame frame, ref Quantum.UltDirection result, in PrototypeMaterializationContext context = default) {
        result.Value = this.Value;
        MaterializeUser(frame, ref result, in context);
    }
  }
  [System.SerializableAttribute()]
  [Quantum.Prototypes.Prototype(typeof(Quantum.UltProcessing))]
  public unsafe partial class UltProcessingPrototype : ComponentPrototype<Quantum.UltProcessing> {
    [HideInInspector()]
    public Int32 _empty_prototype_dummy_field_;
    partial void MaterializeUser(Frame frame, ref Quantum.UltProcessing result, in PrototypeMaterializationContext context);
    public override Boolean AddToEntity(FrameBase f, EntityRef entity, in PrototypeMaterializationContext context) {
        Quantum.UltProcessing component = default;
        Materialize((Frame)f, ref component, in context);
        return f.Set(entity, component) == SetResult.ComponentAdded;
    }
    public void Materialize(Frame frame, ref Quantum.UltProcessing result, in PrototypeMaterializationContext context = default) {
        MaterializeUser(frame, ref result, in context);
    }
  }
  [System.SerializableAttribute()]
  [Quantum.Prototypes.Prototype(typeof(Quantum.Ultimate))]
  public unsafe partial class UltimatePrototype : ComponentPrototype<Quantum.Ultimate> {
    [HideInInspector()]
    public Int32 _empty_prototype_dummy_field_;
    partial void MaterializeUser(Frame frame, ref Quantum.Ultimate result, in PrototypeMaterializationContext context);
    public override Boolean AddToEntity(FrameBase f, EntityRef entity, in PrototypeMaterializationContext context) {
        Quantum.Ultimate component = default;
        Materialize((Frame)f, ref component, in context);
        return f.Set(entity, component) == SetResult.ComponentAdded;
    }
    public void Materialize(Frame frame, ref Quantum.Ultimate result, in PrototypeMaterializationContext context = default) {
        MaterializeUser(frame, ref result, in context);
    }
  }
  [System.SerializableAttribute()]
  [Quantum.Prototypes.Prototype(typeof(Quantum.UltimateId))]
  public unsafe partial class UltimateIdPrototype : ComponentPrototype<Quantum.UltimateId> {
    public Quantum.QEnum32<EUltimateId> Value;
    partial void MaterializeUser(Frame frame, ref Quantum.UltimateId result, in PrototypeMaterializationContext context);
    public override Boolean AddToEntity(FrameBase f, EntityRef entity, in PrototypeMaterializationContext context) {
        Quantum.UltimateId component = default;
        Materialize((Frame)f, ref component, in context);
        return f.Set(entity, component) == SetResult.ComponentAdded;
    }
    public void Materialize(Frame frame, ref Quantum.UltimateId result, in PrototypeMaterializationContext context = default) {
        result.Value = this.Value;
        MaterializeUser(frame, ref result, in context);
    }
  }
  ...
  [System.SerializableAttribute()]
  [Quantum.Prototypes.Prototype(typeof(Quantum.WasUltimating))]
  public unsafe partial class WasUltimatingPrototype : ComponentPrototype<Quantum.WasUltimating> {
    [HideInInspector()]
    public Int32 _empty_prototype_dummy_field_;
    partial void MaterializeUser(Frame frame, ref Quantum.WasUltimating result, in PrototypeMaterializationContext context);
    public override Boolean AddToEntity(FrameBase f, EntityRef entity, in PrototypeMaterializationContext context) {
        Quantum.WasUltimating component = default;
        Materialize((Frame)f, ref component, in context);
        return f.Set(entity, component) == SetResult.ComponentAdded;
    }
    public void Materialize(Frame frame, ref Quantum.WasUltimating result, in PrototypeMaterializationContext context = default) {
        MaterializeUser(frame, ref result, in context);
    }
  }
  [System.SerializableAttribute()]
  ...
  [System.SerializableAttribute()]
  [Quantum.Prototypes.Prototype(typeof(Quantum.WeaponsActive))]
  public unsafe partial class WeaponsActivePrototype : ComponentPrototype<Quantum.WeaponsActive> {
    [HideInInspector()]
    public Int32 _empty_prototype_dummy_field_;
    partial void MaterializeUser(Frame frame, ref Quantum.WeaponsActive result, in PrototypeMaterializationContext context);
    public override Boolean AddToEntity(FrameBase f, EntityRef entity, in PrototypeMaterializationContext context) {
        Quantum.WeaponsActive component = default;
        Materialize((Frame)f, ref component, in context);
        return f.Set(entity, component) == SetResult.ComponentAdded;
    }
    public void Materialize(Frame frame, ref Quantum.WeaponsActive result, in PrototypeMaterializationContext context = default) {
        MaterializeUser(frame, ref result, in context);
    }
  }
  [System.SerializableAttribute()]
